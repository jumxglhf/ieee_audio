...
All of our algorithms and features were implemented in Python. We used the libraries Scikit-learn \cite{b17}, pyAudioAnalysis\cite{b6}, TSVM\cite{b23}\cite{b24} . 
